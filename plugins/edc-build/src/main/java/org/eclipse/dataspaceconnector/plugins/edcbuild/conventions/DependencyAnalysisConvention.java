...
public class DependencyAnalysisConvention implements EdcConvention {
    @Override
        ...
        if (target.getRootProject() == target) {
            ...
            ext.issues(is -> is.all(a -> {
                ...
                a.onUnusedDependencies(i -> i.exclude(
                        ...
                        "org.eclipse.dataspaceconnector:runtime-metamodel",
                        "org.eclipse.dataspaceconnector:autodoc-processor"
                ));
